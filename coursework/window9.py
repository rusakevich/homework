...
class Window9(QtWidgets.QWidget):
    ...
    def tunning(self):
        ...
        self.gbox.addItem(self.spacer1,0,0)
        self.gbox.addItem(self.spacer3,1,0)
        self.gbox.addWidget(self.label_unload,1,1)
        self.gbox.addWidget(self.cbkey,2,1)
        self.gbox.addWidget(self.cbsurname,3,1)
        self.gbox.addWidget(self.cbname,4,1)
        self.gbox.addWidget(self.cbpatronymic,5,1)
        self.gbox.addWidget(self.cbbirthdate,6,1)
        self.gbox.addWidget(self.cbsex,7,1)
        self.gbox.addWidget(self.cbphone,8,1)
        self.gbox.addWidget(self.cbemail,9,1)
        self.gbox.addWidget(self.cbpost,10,1)
        self.gbox.addWidget(self.cbdepartment,11,1)
        self.gbox.addWidget(self.cbdate_of_recruitment,12,1)
        self.gbox.addWidget(self.cbmarital_status,13,1)
        self.gbox.addWidget(self.cbdate_start_vacation,14,1)
        self.gbox.addWidget(self.cbdate_finish_vacation,15,1)
        self.gbox.addWidget(self.cbkind_vacation,16,1)
        self.gbox.addWidget(self.btnUnload,17,1)
        self.gbox.addWidget(self.btnExit,18,1)
        self.gbox.addWidget(self.btndirectory,19,1)
        self.gbox.addWidget(self.label_directory,20,1)
        self.gbox.addItem(self.spacer4,1,2)
        self.gbox.addItem(self.spacer2,21,0)
